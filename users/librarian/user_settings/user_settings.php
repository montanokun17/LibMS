...
<head>
    ...
    <!--Link for CSS File-->
    <link rel="stylesheet" type="text/css" href="/LibMS/users/librarian/user_settings/css/user_settings.css">
...
<nav class="navbar navbar-expand-lg" id="navbar">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="/LibMS/users/librarian/"><i class="fa-solid fa-house fa-xs"></i> Home</a>
        </li>
      </ul>
