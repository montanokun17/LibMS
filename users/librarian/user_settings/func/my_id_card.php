...
<head>
    ...
    <!--Link for CSS File-->
    <link rel="stylesheet" type="text/css" href="/LibMS/users/librarian/user_settings/func/css/my_id_card.css">
    ...
    <script type="text/javascript" src="/LibMS/resources/html2pdf.js-master/dist/html2pdf.bundle.js"></script>
...
<div class="main-box">
    <div class="container">
            <ul class="mini-sidebar">
                <a href="/LibMS/users/librarian/user_settings/func/my_id_card.php">
                    ...
                    <div class="container">
                        <div class="dash-content">
                            ...
                            <div class="form-group">
                                <button id="downloadBtn" class="btn btn-primary btn-sm" style="width:50%; padding:10px; margin-left:25%;"><i class="fa fa-solid fa-file-arrow-down fa-md"></i> <strong>Download PDF</strong></button>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function downloadAsPDF() {
            ...
            html2pdf().from(contentDiv).set(options).outputPdf(function(pdf) {
                // Add watermark logo
                const logoImg = new Image();
                logoImg.src = '/LibMS/resources/images/logov1.png';
                pdf.addImage(logoImg, 'PNG', 10, 10, 40, 40); // Adjust the coordinates and size as needed
