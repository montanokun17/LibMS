              ...
              <table style="margin-top:30px;">
                <tr>
                  ...
                  <td class="box-2 container">
                    ...
                    <form action="/LibMS/users/admin/qrpage/qr-scan.php" method="post" class="form-horizontal">
                    <input type="text" name="text" id="text" readonyy="" placeholder="scan qrcode" class="form-control" style="width:30pc; margin-left:100px;">
                    </form>
                    <?php
