...
<head>
    ...
    <!--Link for CSS File-->
    <link rel="stylesheet" type="text/css" href="/LibMS/users/student/requests/renew/css/renew.css">
                    ...
                    <div class="col-md-8 mx-auto">
                        <form class="form-box" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                            ...
                            <div class="form-group" style="margin-top:20px;">
                                <h2><i class="fa-solid fa-paper-plane"></i> Send Book Renewal Request:</h2>
                            </div>
...
<script>
    ...
    xhr.send("borrowDays=" + borrowDays + "&borrow_id=" + borrow_id);
}
</script>
