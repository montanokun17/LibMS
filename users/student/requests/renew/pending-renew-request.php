                ...
                <div class="inner-box">
                    <div class="container-fluid">
                        <?php
                                ...
                                $query = "SELECT * FROM approved_borrow_reuquests WHERE borrow_status = 'Renewal Pending' ORDER BY borrow_id DESC";
                                ...
                                $totalRequestsQuery = "SELECT COUNT(*) as total FROM approved_borrow_reuquests";
