                    ...
                    <div class="container-fluid">
                        ...
                        <div class="search-bar" id="searchForm">
                            <form>
                                ...
                                <button type="submit" value="search" name="search" id="searchButton" class="btn btn-primary btn-sm"><i class="fa-solid fa-search fa-sm"></i> Search</button>
                            </form>
                            ...
                            if ($result && mysqli_num_rows($result) > 0) {
                                ...
                                while ($book = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo '<td>';
                                        ...
                                        echo '
                                        <a href="/LibMS/users/student/books/details.php?book_id='.$book['book_id'].'">    
