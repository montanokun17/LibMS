...
<head>
    ...
    <!--Link for CSS File-->
    <link rel="stylesheet" type="text/css" href="/LibMS/users/student/history/css/history.css">
            ...
            <div class="row">
                <div class="books-box">
                    <div class="container-fluid">
                        ...
                        $query = "SELECT * FROM book_log_history WHERE borrower_user_id = $idNo  ORDER BY log_id DESC";
